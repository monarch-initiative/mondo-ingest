 ...
 * Number of mappings in [`unmapped_ncit_lex`](unmapped_ncit_lex.tsv): 104
 ...
 * Number of mappings in [`mondo_exactmatch_ncit`](split-mapping-set/mondo_exactmatch_ncit.tsv): 136
 ...
 * Number of mappings in [`mondo_closematch_doid`](split-mapping-set/mondo_closematch_doid.tsv): 214
