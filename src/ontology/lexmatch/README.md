 ...
 * Number of mappings in [`unmapped_omim_lex`](unmapped_omim_lex.tsv): 16
 ...
 * Number of mappings in [`mondo_exactmatch_omimps`](split-mapping-set/mondo_exactmatch_omimps.tsv): 23
 * Number of mappings in [`mondo_closematch_omimps`](split-mapping-set/mondo_closematch_omimps.tsv): 26
