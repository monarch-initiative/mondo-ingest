...
# OMIM
$(EXTERNAL_CONTENT_DIR)/mondo_genes.robot.tsv:
	mkdir -p $(EXTERNAL_CONTENT_DIR)
	wget "https://github.com/monarch-initiative/omim/releases/latest/download/mondo_genes.robot.tsv" -O $@
.PRECIOUS: $(EXTERNAL_CONTENT_DIR)/mondo_genes.robot.tsv

.PHONY: external-content-omim
external-content-omim: $(EXTERNAL_CONTENT_DIR)/mondo_genes.robot.owl $(EXTERNAL_CONTENT_DIR)/mondo_genes.robot.tsv
