These notes are for the EDITORS of mondo-ingest
...
Make sure you have an ID range in the [idranges file](mondo-ingest-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [mondo-ingest-edit.owl](mondo-ingest-edit.owl)

** DO NOT EDIT mondo-ingest.obo OR mondo-ingest.owl in the top level directory **

[../../mondo-ingest.owl](../../mondo-ingest.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch-initiative/mondo-ingest) for details.
 ...
 * [mondo-ingest-idranges.owl](mondo-ingest-idranges.owl)
 ...
 * https://github.com/monarch-initiative/mondo-ingest/releases
 * https://github.com/monarch-initiative/mondo-ingest/releases/new
...
what is in the `owl:versionIRI` of the derived mondo-ingest.owl (`data-version` in
mondo-ingest.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/mondo-ingest.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/mondo-ingest/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch-initiative/mondo-ingest.svg?branch=master)](https://travis-ci.org/monarch-initiative/mondo-ingest)
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to mondo-ingest
